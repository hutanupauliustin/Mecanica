...
// include: /tmp/tmpk5hxhia8.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'simulator.data';
      var REMOTE_PACKAGE_BASE = 'simulator.data';
...
Module['FS_createPath']("/", "exemple", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_simulator.data');
      }
      Module['addRunDependency']('datafile_simulator.data');
    ...
    loadPackage({"files": [{"filename": "/exemple/demolare.json", "start": 0, "end": 2880}, {"filename": "/exemple/grinda.json", "start": 2880, "end": 3858}, {"filename": "/exemple/newton.json", "start": 3858, "end": 7639}, {"filename": "/exemple/pendul.JSON", "start": 7639, "end": 9934}, {"filename": "/exemple/pod.json", "start": 9934, "end": 12496}], "remote_package_size": 12496});
...
/** @type {function(string, boolean=, number=)} */
  ...
  var _glfwGetJoystickAxes = (joy, count) => {
      ...
      HEAP32[((count)>>2)] = state.axesCount;checkInt32(state.axesCount);
      return state.axes;
    };
  ...
  var _glfwGetJoystickButtons = (joy, count) => {
      ...
      HEAP32[((count)>>2)] = state.buttonsCount;checkInt32(state.buttonsCount);
