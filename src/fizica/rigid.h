...
namespace materiale {
    ...
    inline constexpr tipMaterial Cauciuc = {0.8f,       0.9f,   0.7f,    0.05f,       0.02f};
    inline constexpr tipMaterial Gheata =  {0.1f,       0.05f,  0.01f,   0.01f,       0.007f};
    inline constexpr tipMaterial Lemn =    {0.4f,       0.5f,   0.4f,    0.02f,       0.05f};
    inline constexpr tipMaterial Piatra =  {0.2f,       0.8f,   0.6f,    0.04f,       0.01f};
}
