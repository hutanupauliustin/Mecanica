...
\title{Motor Fizic 2D pentru Corpuri Legate } % \\ \large Modelarea Dinamicii și a Legăturilor Unilaterale}
...
\section{Decetia si Rezolvarea Coliziunilor}
\subsection{Arhitectura sistemului de geometrie: Decuplarea componentei fizice de forma geometrica (Collider, Manifold).}
\subsection{Faza de filtrare (Broad-Phase): Optimizarea performantei folosind cutii de incadrare aliniate la axe (AABB).}
\subsection{Faza de detectie exacta (Narrow-Phase): Aplicarea Teoremei Axelor de Separare (SAT) pentru poligoane convexe rotite.}
...
\subsection{Integrarea numerica: Alegerea si implementarea metodei Runge-Kutta de ordinul 4 (RK4) pentru stabilitate.}
...
\bibitem{text5} \url{convex geometry - Proof of Separating Axis Theorem for polygons - Mathematics Stack Exchange https://share.google/ckcu5Mbb9Eq8XtJ3l}
\end{thebibliography}
