...
\begin{tikzpicture}[scale=1.5, >=stealth]
    ...
    \draw[->, thick] (Cl) ++(1.4, 0) arc (0:30:1.4) node[midway, right=2pt] {$\varphi_A$};
...
\begin{align}
    \bar{v}_{cA} &= \bar{v}_A + \bar{\omega}_A \times \bar{r}_{1A} \\
    \bar{v}_{cB} &= \bar{v}_B + \bar{\omega}_B \times \bar{r}_{2B} 
\end{align}
