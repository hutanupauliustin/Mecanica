...
\subsubsection{Calculul Impulsului}
...
Unde:
\begin{itemize}
    \item $e$ este coeficientul de restituție (elasticitatea impactului).
    \item $v_n$ este viteza relativă a punctelor de contact proiectată pe normală: $v_n = \langle \vec{v}_{rel}, \vec{n} \rangle$.
    \item $\vec{r}_A$ și $\vec{r}_B$ sunt vectorii de distanță de la centrele de masă la punctul de contact.
    \item $I_A$ și $I_B$ sunt momentele de inerție principale.
\end{itemize}
...
$$ \vec{v}_A = \vec{v}_A - \vec{J} \cdot invM_A $$
$$ \omega_A = \omega_A - \frac{\vec{r}_A \times \vec{J}}{I_A} $$
$$ \vec{v}_B = \vec{v}_B + \vec{J} \cdot invM_B $$
$$ \omega_B = \omega_B + \frac{\vec{r}_B \times \vec{J}}{I_B} $$
\subsection{Rezolvarea coliziunilor: Calculul impulsului si frecarea Coulomb.}
